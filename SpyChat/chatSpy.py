...
status=["Hi,Deepti!","Just live the present moment"]
print "Hi!Welcome to spy_chat"
input="Which way u want to continue "+spy.salutation + " " + spy.name + "\nPress 1 for yes \nPress 2 for no"


# Older status and current status
...
#Completetion for successfully added friend
...
# Selection of the friend for chating
def select_friend():
    item_number = 0
...
#Welcoming spy and adding person credentials
if exist == "1":
    start_chat(spy)
else:
    spy = Spy('','',0,0.0)
